...
Neste trabalho, o tema é a construção de um sistema de recomendações pertencente a uma terceira categoria: Baseado em confiança.
Trata-se de um metodo baseado em estimativas do sentimento de confiança entre os pesquisadores.
...
\subsubsection{Técnicas de Recomendação para usuários de Bibliotecas Digitais}
...
representados pelos termos que os definem e organizados em uma hierarquia. A ontologia serve para descrever as relações entre 
...
recursos para trabalhos relacionados a manipulação de dados e computação numérica.% \cite{python book} 
...
% Paragrafo/frase explicando a figura
