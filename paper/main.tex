...
em um banco de dados com informações da plataforma lattes. O sistema deve analisar o perfil dos pesquisadores e então 
fazer sugestões de conteúdo relevante e pesquisadores com o perfil semelhante. Para tal, deve-se:
