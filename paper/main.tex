...
\begin{center}
  $ G_{u}^{n} = v | v \in F_{G_{u}^{n}}, v \notin B_{G_{u}^{n-1, n-2 ... 0}} $
\end{center}

Assim, $F_{G_{u}^{n}}$ e $B_{G_{u}^{n-1, n-2 ... 0}}$ ambos  representam um grupo de pesquisadores que publicaram obras em conjunto 
com os pesquisadores do conjunto $G_{u}^{n}$, considerado um voto de  confiança. A diferença é que os pesquisadores do conjunto 
$B_{G_u^{n-1, n-2 ... 0}}$ já apareceram na rede de confiança de $u$.
...
\subsection{Selecionando recomendações}
