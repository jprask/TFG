...
$B_u$ de páginas que fazem referência à $u$. Considerando uma matriz de adjacência $A_{u,v}$ na qual o valor é $^1/_{N_u}$ nas 
...
seria aproximadamente igual ao número de publicações em conjunto \textbf{centralidade}. Enquanto esta métrica é relevante, perde-se a 
...
Os autores fazem isso definindo um parâmetro $\alpha$ para ajustar a importância de grau e força:
